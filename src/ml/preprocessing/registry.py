...
CURATED_CONCEPTS = [
    ...
    ("KLoSA", "hypertension_dx", "w__C006", "고혈압 진단 여부", "target_source", "category", "code", "", "", "동시점 입력 금지; t+1 신규진단 타깃 생성에만 사용"),
    ("KLoSA", "diabetes_dx", "w__C011", "당뇨병 또는 고혈당 진단 여부", "target_source", "category", "code", "", "", "동시점 입력 금지; t+1 신규진단 타깃 생성에만 사용"),
    ("KLoSA", "survey_weight", "w__wgt_ac", "통합 횡단가중치", "survey_design", "float", "weight", 0, "", "예측 특성으로 사용 금지"),
    ...
    ("KNHANES", "systolic_bp", "HE_SBP", "최종 수축기혈압", "target_component", "float", "mmHg", 50, 300, "고혈압 유병 타깃 정의에 포함될 수 있어 입력 금지"),
    ("KNHANES", "diastolic_bp", "HE_DBP", "최종 이완기혈압", "target_component", "float", "mmHg", 30, 200, "고혈압 유병 타깃 정의에 포함될 수 있어 입력 금지"),
    ("KNHANES", "fasting_glucose", "HE_GLU", "공복혈당", "target_component", "float", "mg/dL", 20, 800, "당뇨병 유병 타깃 정의에 포함될 수 있어 입력 금지"),
    ("KNHANES", "hba1c", "HE_HbA1c", "당화혈색소", "target_component", "float", "%", 2, 25, "당뇨병 유병 타깃 정의에 포함될 수 있어 입력 금지"),
    ("KNHANES", "hypertension_prevalence", "HE_HP", "고혈압 유병 여부", "target", "category", "code", "", "", "타깃 전용"),
    ("KNHANES", "diabetes_prevalence", "HE_DM", "당뇨병 유병 여부", "target", "category", "code", "", "", "타깃 전용"),
    ("KNHANES", "survey_weight", "wt_itvex", "건강설문·검진 가중치", "survey_design", "float", "weight", 0, "", "예측 특성으로 사용 금지"),
    ("KNHANES", "strata", "kstrata", "분산추정층", "survey_design", "category", "code", "", "", "예측 특성으로 사용 금지"),
